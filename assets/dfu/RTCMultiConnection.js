...
var RTCMultiConnection = function(roomid, forceOptions) {
    ...
    (function(connection) {
        ...
        function connectSocket(connectCallback) {
            ...
            if (connection.socketInit) { // todo: check here readySate/etc. to make sure socket is still opened
                if (connectCallback) {
                    connectCallback(connection.socket);
                }
                return;
        ...
        connection.closeEntireSession = function(callback) {
            callback = callback || function() {};
            connection.socket.emit('close-entire-session', function looper(closed, error) {
                console.log('close-entire-session callback closed = ' + closed + ' error = ' + error);
        ...
        connection.setSocket = function(socket) {
